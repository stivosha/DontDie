...
{
    class PlayerAnimator : IAnimator
    {
        public Dictionary<States, Image[]> Animation { get; set; }
        private const string BaseUrl = "Textures/Animation/Player/";
        public PlayerAnimator()
        {
            Animation = new Dictionary<States, Image[]>
            {
                [States.StandDown] = GetAnimationFromFile(BaseUrl + "Idle/Char_idle_down.png"),
                [States.StandUp] = GetAnimationFromFile(BaseUrl + "Idle/Char_idle_up.png"),
                [States.StandLeft] = GetAnimationFromFile(BaseUrl + "Idle/Char_idle_left.png"),
                [States.StandRight] = GetAnimationFromFile(BaseUrl + "Idle/Char_idle_right.png"),

                [States.MoveDown] = GetAnimationFromFile(BaseUrl + "Walk/Char_walk_down.png"),
                [States.MoveUp] = GetAnimationFromFile(BaseUrl + "Walk/Char_walk_up.png"),
                [States.MoveLeft] = GetAnimationFromFile(BaseUrl + "Walk/Char_walk_left.png"),
                [States.MoveRight] = GetAnimationFromFile(BaseUrl + "Walk/Char_walk_right.png"),
